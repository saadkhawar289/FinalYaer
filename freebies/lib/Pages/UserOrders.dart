...
Widget _buildFeaturedProductsList(BuildContext context){
    ...
    return ScopedModelDescendant<MainModel>(builder: (BuildContext context, Widget child, MainModel model){
      Widget content = Center(child:Text('No Product Available'));
      ...
      return RefreshIndicator( onRefresh:model.fetchWhishlitProducts,child: content);// this is used to refresh the page by swiping down the screen
    }
    );
  }
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                       ...
                       //  crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            CircleAvatar(backgroundImage: NetworkImage(widget.model.singleUser.image), radius: MediaQuery.of(context).size.width*0.030 ,),
                                                        SizedBox(height: 20),

                            Text(widget.model.singleUser.name,
                                style: TextStyle(
                           ...
                           Align(alignment: Alignment.centerLeft,
                              child:Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(widget.model.singleUser.address))
                                ],
                              )
                            ),
                            SizedBox(height: 10),
                            ...
                            Align(alignment: Alignment.centerLeft,
                              child:Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(widget.model.singleUser.number))
                                ],
                              )
                            ),
                                                        SizedBox(height: 10),
                            ...
                            Align(alignment: Alignment.centerLeft,
                              child:Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(widget.model.singleUser.email))
                                ],
                              )
                            ),
                                                        SizedBox(height: 10),
