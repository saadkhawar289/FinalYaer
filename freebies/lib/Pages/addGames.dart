...
class AddGames extends StatefulWidget {
  @override
  _AddGamesPageState createState() => _AddGamesPageState();
}

class _AddGamesPageState extends State<AddGames> {
 ...
 Widget _buildLinkTextField(Games product) {
 ...
 Widget _buildTittleTextField(Games product){
...
void _submitForm(
 ...
 Widget _pageContent(BuildContext context,Games game) {
   if (kIsWeb) {
                 ...
                 SizedBox(height: 10,),
                  Text("Add Details",
                      style:TextStyle(fontSize: 20.0, fontWeight:FontWeight.bold),),
                                       SizedBox(height: 10,),
                _buildLinkTextField(game),
                _buildTittleTextField(game),
  ...
  Widget build(BuildContext context) {
    ...
    return ScopedModelDescendant<MainModel>(
      builder: (BuildContext context, Widget child, MainModel model) {
        ...
        final Widget pageContent = _pageContent(context,model.selcectedGame);
